...
=======
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        "grid-pattern": "linear-gradient(rgba(42,42,42,0.05) 1px, transparent 1px), linear-gradient(90deg, rgba(42,42,42,0.05) 1px, transparent 1px)",
        "radial-glow": "radial-gradient(ellipse at center, rgba(0,255,170,0.05) 0%, rgba(0,0,0,0.4) 70%)",
        "hero-gradient": "linear-gradient(to bottom, rgba(0,0,0,0.7) 0%, rgba(0,0,0,0.9) 100%)",
      },
      backgroundSize: {
        "grid": "40px 40px",
