...
| **⚛️ `client/`** | Frontend Application (React/Vite) | `L33` |
| **🔧 `config/`** | Shared build/tooling configuration | `L773` |
| **🗄️ `db/`** | Database schema, migrations, and seeds | `L783` |
| **📚 `docs/`** | Project documentation | `L1044` |
| **🛠️ `scripts/`** | Development & utility scripts | `L1207` |
| **⚙️ `server/`** | Backend Server (Express) | `L1487` |
| **🤝 `shared/`** | Isomorphic code (client & server) | `L1850` |
| **🧪 `tests/`** | End-to-end tests (Playwright) | `L1967` |
