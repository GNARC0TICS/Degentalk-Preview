...
| **🔧 `config/`** | Shared build/tooling configuration | `L798` |
| **🗄️ `db/`** | Database schema, migrations, and seeds | `L807` |
| **📚 `docs/`** | Project documentation | `L1066` |
| **🛠️ `scripts/`** | Development & utility scripts | `L1227` |
| **⚙️ `server/`** | Backend Server (Express) | `L1490` |
| **🤝 `shared/`** | Isomorphic code (client & server) | `L1851` |
| **🧪 `tests/`** | End-to-end tests (Playwright) | `L1965` |
