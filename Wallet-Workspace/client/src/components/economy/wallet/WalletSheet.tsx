...
import { 
  ...
  QrCode, Copy, ExternalLink, AlertCircle, Inbox, RefreshCw,
          ...
          <SheetHeader className="p-4 sm:p-6 pb-4 border-b border-zinc-800 flex-none bg-gradient-to-r from-zinc-900 to-zinc-900/90">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <SheetTitle className="text-xl text-emerald-400">
                    Wallet Dashboard
                  </SheetTitle>
                    ...
                    <div className="space-y-4">
                      <div className="bg-gradient-to-br from-zinc-800/40 to-zinc-800/20 rounded-lg p-4 sm:p-6 border border-zinc-700/50 backdrop-blur-sm">
                        ...
                        <div className="bg-black/50 rounded-lg p-6 flex flex-col items-center justify-center text-center border border-zinc-800/50">
                          ...
                          <h4 className="text-white font-medium mb-2">Deposit Feature Coming Soon</h4>
                          <p className="text-zinc-500 text-sm mb-4">We're working on secure deposit integration</p>
                        ...
                        <div className="flex items-start space-x-2 mt-4 p-3 bg-amber-900/20 rounded-lg border border-amber-900/30">
                          ...
                          <div className="text-sm text-amber-200">
                            ...
                            <p className="text-amber-300/80">Always verify you're on the official Degentalk™™ platform before making any transactions.</p>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="bg-gradient-to-br from-zinc-800/40 to-zinc-800/20 rounded-lg p-4 sm:p-6 border border-zinc-700/50 backdrop-blur-sm">
                        <div className="flex items-start space-x-3 mb-4">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-zinc-400 mb-4">Enter the amount and destination address to withdraw your funds.</p>
                          </div>
                        </div>
                      ...
                      <div className="bg-gradient-to-br from-zinc-800/40 to-zinc-800/20 rounded-lg p-4 sm:p-6 border border-zinc-700/50 backdrop-blur-sm">
                        <div className="flex items-start space-x-3 mb-4">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-zinc-400 mb-4">Purchase DGT tokens to use across the platform for tips, rain, and more.</p>
                          </div>
                        </div>
                        ...
                        <div className="space-y-4">
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            ...
                            <div className="bg-black/30 rounded-lg p-3 border border-zinc-800">
                              ...
                              <div className="text-sm font-medium text-white">{walletDataWithDefaults.dgtPoints.toLocaleString()}</div>
                            </div>
                          </div>
                  ...
                  {isLoadingTransactions ? (
                    ...
                    <div className="divide-y divide-zinc-800/50">
                      {transactions.slice(0, maxTransactionsToShow).map((tx, index) => (
                        <div key={tx.id} className="p-4 flex items-center justify-between transition-colors hover:bg-zinc-800/30 group">
                          <div className="flex items-center space-x-3 overflow-hidden flex-1">
                            <div className={cn(
                              "w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 transition-colors",
                              tx.type === 'deposit' && 'bg-green-900/30 text-green-500 group-hover:bg-green-900/40',
                              tx.type === 'withdrawal' && 'bg-red-900/30 text-red-500 group-hover:bg-red-900/40',
                              (tx.type === 'purchase' || tx.type === 'tip') && 'bg-amber-900/30 text-amber-500 group-hover:bg-amber-900/40'
                            )}>
                              {tx.type === 'deposit' ? (
                            ...
                            <div className="min-w-0 flex-1">
                              <div className="text-sm font-medium truncate text-white">{tx.description}</div>
                      ...
                      {transactions.length > maxTransactionsToShow && (
                        ...
                        >
                          <div className="flex items-center justify-center space-x-2">
                            ...
                            <span>View {transactions.length - maxTransactionsToShow} more transactions</span>
                          </div>
                        </button>
                      )}
                    </div>
