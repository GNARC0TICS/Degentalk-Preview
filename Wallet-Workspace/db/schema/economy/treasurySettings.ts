import { pgTable, serial, text, varchar, integer, doublePrecision, boolean, timestamp, numeric } from "drizzle-orm/pg-core";
import { users } from "../user/users"; 
import { sql } from 'drizzle-orm';

// This table is for platform-wide treasury settings, potentially for multiple currencies (e.g., CCPayment)
export const platformTreasurySettings = pgTable('platform_treasury_settings', { // Renamed table
