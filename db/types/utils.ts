...
export const IdValidators = {
	user: (value: unknown): value is Id<'user'> => typeof value === 'string' && isValidUuid(value),

	thread: (value: unknown): value is Id<'thread'> =>
		typeof value === 'string' && isValidUuid(value),

	post: (value: unknown): value is Id<'post'> => typeof value === 'string' && isValidUuid(value),

	wallet: (value: unknown): value is Id<'wallet'> => typeof value === 'string' && isValidUuid(value)
} as const;
