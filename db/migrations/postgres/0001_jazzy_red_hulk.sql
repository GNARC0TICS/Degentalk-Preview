...
CREATE TYPE "public"."notification_type" AS ENUM('info', 'system', 'private_message', 'achievement', 'transaction', 'post_mention', 'thread_reply', 'reaction', 'quest_complete', 'badge_awarded', 'rain_received', 'level_up', 'tip_received', 'airdrop_received', 'referral_complete', 'cosmetic_unlocked');--> statement-breakpoint
...
CREATE TYPE "public"."event_type" AS ENUM('rain_claimed', 'thread_created', 'post_created', 'cosmetic_unlocked', 'level_up', 'badge_earned', 'tip_sent', 'tip_received', 'xp_earned', 'referral_completed', 'product_purchased', 'airdrop_claimed');--> statement-breakpoint
...
CREATE TABLE "backup_settings" (
	...
	"allowed_backup_roles" jsonb DEFAULT '["admin", "moderator"]',
...
CREATE TABLE "reputation_achievements" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "reputation_achievements_achievement_key_unique" UNIQUE("achievement_key")
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE "xp_reputation_settings" (
...
CREATE TABLE "titles" (
	...
	"unlock_type" varchar(20) DEFAULT 'manual' NOT NULL,
	"min_level" integer,
...
ALTER TABLE "user_reputation_log" ADD CONSTRAINT "user_reputation_log_user_id_users_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("user_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "user_reputation_log" ADD CONSTRAINT "user_reputation_log_achievement_id_reputation_achievements_id_fk" FOREIGN KEY ("achievement_id") REFERENCES "public"."reputation_achievements"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_user_reputation" ON "user_reputation_log" USING btree ("user_id","created_at");--> statement-breakpoint
...
CREATE INDEX "idx_threads_author_id" ON "threads" USING btree ("user_id");--> statement-breakpoint
...
CREATE INDEX "idx_threads_is_boosted_flag" ON "threads" USING btree ("is_boosted");--> statement-breakpoint
