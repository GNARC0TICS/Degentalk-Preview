import { pgTable, serial, uuid, varchar, text, doublePrecision, integer, jsonb, boolean, timestamp, index } from "drizzle-orm/pg-core";
...
export const products = pgTable('products', {
  ...
  featuredImageId: integer('featured_image_id').references(() => mediaLibrary.id, { onDelete: 'set null' }),
  ...
  digitalFileId: integer('digital_file_id').references(() => mediaLibrary.id, { onDelete: 'set null' }),
