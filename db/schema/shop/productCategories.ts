import { pgTable, serial, AnyPgColumn, varchar, text, integer, boolean, timestamp, index } from "drizzle-orm/pg-core";
...
export const productCategories = pgTable('product_categories', {
  ...
  parentId: integer('parent_id').references((): AnyPgColumn => productCategories.id, { onDelete: 'set null' }),
