...
export const userSocialPreferences = pgTable('user_social_preferences', {
	...
	friendRequestPermissions: varchar('friend_request_permissions', { length: 20 }).default('everyone').notNull(), // everyone, mutuals, followers, none
	...
	allowDirectMessages: varchar('allow_direct_messages', { length: 20 }).default('friends').notNull(), // friends, followers, everyone, none
