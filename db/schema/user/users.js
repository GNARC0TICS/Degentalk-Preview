import { pgTable, text, varchar, boolean, timestamp, integer, bigint, uuid, jsonb, unique } from 'drizzle-orm/pg-core';
...
export const users = pgTable('users', {
    ...
    pinnedPostId: uuid('pinned_post_id').references(() => posts.id, {
        onDelete: 'set null'
    }),
