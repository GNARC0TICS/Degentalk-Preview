 ...
 */
export const economyConfigOverrides = pgTable(
	...
	(table) => ({
		idx_economyConfigOverrides_createdAt: index('idx_economyConfigOverrides_createdAt').on(
			table.createdAt
		),
		idx_economyConfigOverrides_updatedAt: index('idx_economyConfigOverrides_updatedAt').on(
			table.updatedAt
		)
	})
);
