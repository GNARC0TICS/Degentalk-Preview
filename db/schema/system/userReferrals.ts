import { pgTable, serial, integer, timestamp, boolean, jsonb, unique, uuid } from 'drizzle-orm/pg-core';
...
export const userReferrals = pgTable(
  'user_referrals',
  {
    ...
    referredByUserId: uuid('referred_by_user_id').references(() => users.id, { onDelete: 'set null' }),
