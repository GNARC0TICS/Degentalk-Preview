import { pgTable, varchar, doublePrecision, timestamp, jsonb, text, index, uuid } from 'drizzle-orm/pg-core';
...
const walletAddressSchema = z.union([
    ...
    z
        .string()
        .refine((addr) => isDevelopment() &&
        ['TREASURY_SYSTEM_TRON_ADDRESS', 'TRzJRNqjgmzCR4zwm6wLMnECDj35zZZnVt'].includes(addr), { message: 'Invalid wallet address format for dev/test specific values' })
]);
