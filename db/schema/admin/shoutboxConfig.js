...
import { pgTable, varchar, boolean, integer, timestamp, jsonb, text, unique, uuid } from 'drizzle-orm/pg-core';
 ...
 */
export const shoutboxConfig = pgTable('shoutbox_config', {
    ...
    exportFormats: jsonb('export_formats').$type().default(['json', 'csv', 'txt']),
 ...
 */
export const shoutboxUserIgnores = pgTable('shoutbox_user_ignores', {
    id: varchar('id', { length: 128 })
        .primaryKey()
        .$defaultFn(() => createId()),
    userId: uuid('user_id')
...
//# sourceMappingURL=shoutboxConfig.js.map