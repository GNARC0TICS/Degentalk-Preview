import { pgTable, serial, text, varchar, boolean, integer, timestamp, jsonb, index } from "drizzle-orm/pg-core";
...
export const announcements = pgTable('announcements', {
  ...
  visibleTo: jsonb('visible_to').$type<string[]>().default(JSON.stringify(['all'])), // Storing as JSON string array
