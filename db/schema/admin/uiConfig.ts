...
export const uiCollectionQuotes = pgTable('ui_collection_quotes', {
    ...
    collectionId: uuid('collection_id').notNull().references(() => uiCollections.id, { onDelete: 'cascade' }),
    quoteId: uuid('quote_id').notNull().references(() => uiQuotes.id, { onDelete: 'cascade' }),
