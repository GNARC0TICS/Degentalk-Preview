import { pgTable, integer, text, boolean, timestamp, uuid, bigint, jsonb, index, varchar } from 'drizzle-orm/pg-core';
...
export const posts = pgTable('posts', {
    ...
    replyToPostId: uuid('reply_to_post_id').references(() => posts.id, {
        onDelete: 'set null'
    }),
