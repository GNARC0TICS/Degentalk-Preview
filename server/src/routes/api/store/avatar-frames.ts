...
import { avatarFrameStoreService } from '@server/domains/cosmetics/avatarFrameStore.service';
import { isAuthenticated } from '@server/domains/auth/middleware/auth.middleware';
import { frameEquipService } from '@server/domains/cosmetics/frameEquip.service';
import { dgtService } from '@server/domains/wallet/dgt.service';
...
import { CosmeticsTransformer } from '@server/domains/shop/transformers/cosmetics.transformer';
