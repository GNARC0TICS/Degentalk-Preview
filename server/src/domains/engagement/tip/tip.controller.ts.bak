...
export class TipController {
  ...
  getTipHistory = asyncHandler(async (req: Request, res: Response) => {
    ...
    const tipHistory = await this.tipService.getTipHistory(
      userId,
      limit,
      offset,
      type
  ...
  getTipLeaderboard = asyncHandler(async (req: Request, res: Response) => {
    ...
    const leaderboard = await this.tipService.getTipLeaderboard(
      period,
      type,
      limit
    );
  ...
  updateTipSettings = asyncHandler(async (req: Request, res: Response) => {
    ...
    const updatedSettings = await this.tipService.updateTipSettings(
      userId,
      validatedData
    );
