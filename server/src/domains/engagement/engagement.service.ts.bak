...
export class EngagementService {
  ...
  async processTip(
    ...
    try {
      return await tipService.processTip(
        fromUserId,
        toUserId,
        amount,
        reason,
  ...
  async processRain(
    ...
    try {
      return await rainService.processRain(
        fromUserId,
        amount,
        recipientCount,
        channelId
  ...
  async processAirdrop(
    ...
    try {
      return await airdropService.processAirdrop(
        adminUserId,
        targetUserIds,
        amount,
        reason
  ...
  async getUserEngagementStats(userId: number) {
    try {
      ...
      return {
        ...
        totalReceived: tipStats.totalReceived + rainStats.totalReceived + airdropStats.totalReceived,
        transactionCount: tipStats.transactionCount + rainStats.transactionCount + airdropStats.transactionCount
      };
    } catch (error) {
