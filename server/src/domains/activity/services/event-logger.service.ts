...
export class EventLoggerService {
   ...
   */
  async logPostCreated(userId: string, postId: string, threadId: string, meta: Record<string, any> = {}) {
   ...
   */
  async logLevelUp(userId: string, oldLevel: number, newLevel: number, meta: Record<string, any> = {}) {
   ...
   */
  async logBadgeEarned(userId: string, badgeId: string, badgeName: string, meta: Record<string, any> = {}) {
