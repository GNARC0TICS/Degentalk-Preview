...
export class AdminError extends Error {
	constructor(
		...
		console.warn(
			'⚠️ WARNING: server/src/domains/admin/admin.errors.ts is deprecated. Use server/src/core/errors.ts instead.'
		);
	}
	...
	static unauthorized(message: string = 'Unauthorized access'): AdminError {
		console.warn(
			'⚠️ WARNING: AdminError.unauthorized from admin.errors.ts is deprecated. Use AdminError from core/errors.ts instead.'
		);
	...
	static forbidden(message: string = 'Access forbidden'): AdminError {
		console.warn(
			'⚠️ WARNING: AdminError.forbidden from admin.errors.ts is deprecated. Use AdminError from core/errors.ts instead.'
		);
	...
	static notFound(entity: string, id?: number | string): AdminError {
		console.warn(
			'⚠️ WARNING: AdminError.notFound from admin.errors.ts is deprecated. Use AdminError from core/errors.ts instead.'
		);
	...
	static validation(message: string = 'Validation error', details?: any): AdminError {
		console.warn(
			'⚠️ WARNING: AdminError.validation from admin.errors.ts is deprecated. Use AdminError from core/errors.ts instead.'
		);
	...
	static duplicate(entity: string, field: string, value: string): AdminError {
		console.warn(
			'⚠️ WARNING: AdminError.duplicate from admin.errors.ts is deprecated. Use AdminError from core/errors.ts instead.'
		);
