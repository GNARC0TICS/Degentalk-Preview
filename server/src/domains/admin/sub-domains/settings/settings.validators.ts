...
export const SettingGroupSchema = z.object({
  ...
  key: z.string().min(2).max(50).regex(/^[a-z0-9_]+$/, "Group key must contain only lowercase letters, numbers, and underscores"),
...
export const CreateSettingSchema = z.object({
  key: z.string().min(2).max(50).regex(/^[a-z0-9_]+$/, "Setting key must contain only lowercase letters, numbers, and underscores"),
