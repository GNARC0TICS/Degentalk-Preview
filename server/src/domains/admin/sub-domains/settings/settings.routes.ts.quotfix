...
router.get(
	'/feature-flags',
	asyncHandler(adminSettingsController.getFeatureFlags.bind(adminSettingsController))
);
router.put(
	'/feature-flags/:key',
	asyncHandler(adminSettingsController.updateFeatureFlag.bind(adminSettingsController))
);
