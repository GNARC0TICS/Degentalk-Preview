...
export const createEmoji = async (req: Request, res: Response) => {
    try {
        ...
        logger.info('EMOJI_CONTROLLER', `Successfully created emoji: ${newEmoji.name} (ID: ${newEmoji.id})`);
...
export const updateEmoji = async (req: Request, res: Response) => {
    try {
        logger.info('EMOJI_CONTROLLER', `PUT /api/admin/emojis/${req.params.id} requested`, { body: req.body });
...
export const bulkDeleteEmojis = async (req: Request, res: Response) => {
    try {
        logger.info('EMOJI_CONTROLLER', 'POST /api/admin/emojis/bulk-delete requested', { body: req.body });
