...
export const getXpSettings = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    logger.error('XP_ADMIN_CONTROLLER', 'Error getting XP settings:', error instanceof Error ? error.message : String(error));
    next(error);
  }
};
...
export const updateXpSettings = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    logger.error('XP_ADMIN_CONTROLLER', 'Error updating XP settings:', error instanceof Error ? error.message : String(error));
    next(error);
  }
};
...
export const getLevels = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    logger.error('XP_ADMIN_CONTROLLER', 'Error getting levels:', error instanceof Error ? error.message : String(error));
    next(error);
  }
};
...
export const createLevel = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    logger.error('XP_ADMIN_CONTROLLER', 'Error creating level:', error instanceof Error ? error.message : String(error));
    next(error);
  }
};
...
export const updateLevel = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    logger.error('XP_ADMIN_CONTROLLER', 'Error updating level:', error instanceof Error ? error.message : String(error));
    next(error);
  }
};
...
export const deleteLevel = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    logger.error('XP_ADMIN_CONTROLLER', 'Error deleting level:', error instanceof Error ? error.message : String(error));
    next(error);
  }
};
...
export const getBadges = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    logger.error('XP_ADMIN_CONTROLLER', 'Error getting badges:', error instanceof Error ? error.message : String(error));
    next(error);
  }
};
...
export const createBadge = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    logger.error('XP_ADMIN_CONTROLLER', 'Error creating badge:', error instanceof Error ? error.message : String(error));
    next(error);
  }
};
...
export const updateBadge = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    logger.error('XP_ADMIN_CONTROLLER', 'Error updating badge:', error instanceof Error ? error.message : String(error));
    next(error);
  }
};
...
export const deleteBadge = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    logger.error('XP_ADMIN_CONTROLLER', 'Error deleting badge:', error instanceof Error ? error.message : String(error));
    next(error);
  }
};
...
export const getTitles = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    logger.error('XP_ADMIN_CONTROLLER', 'Error getting titles:', error instanceof Error ? error.message : String(error));
    next(error);
  }
};
...
export const createTitle = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    logger.error('XP_ADMIN_CONTROLLER', 'Error creating title:', error instanceof Error ? error.message : String(error));
    next(error);
  }
};
...
export const updateTitle = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    logger.error('XP_ADMIN_CONTROLLER', 'Error updating title:', error instanceof Error ? error.message : String(error));
    next(error);
  }
};
...
export const deleteTitle = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    logger.error('XP_ADMIN_CONTROLLER', 'Error deleting title:', error instanceof Error ? error.message : String(error));
    next(error);
  }
};
...
export const adjustUserXp = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    logger.error('XP_ADMIN_CONTROLLER', 'Error adjusting user XP:', error instanceof Error ? error.message : String(error));
...
export const getXpAdjustmentLogs = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    logger.error('XP_ADMIN_CONTROLLER', 'Error getting XP adjustment logs:', error instanceof Error ? error.message : String(error));
    next(error);
  }
};
...
export const testXpActionAward = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    logger.error('XP_ADMIN_CONTROLLER', 'Error testing XP action award:', error instanceof Error ? error.message : String(error));
    if (error.message && error.message.includes('not found')) {
      return res.status(404).json({ message: error.message });
    }
    next(error);
