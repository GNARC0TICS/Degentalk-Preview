 ...
 */
export const getUserMissionProgressById = async (req: Request, res: Response, next: NextFunction) => {
  try {
 ...
 */
export const initializeDefaultMissions = async (req: Request, res: Response, next: NextFunction) => {
  try {
