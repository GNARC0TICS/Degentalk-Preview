...
export class MentionsService {
	 ...
	 */
	static async getUserMentionPreferences(userId: string) {
	...
	static async checkMentionPermissions(
		...
		if (mentioningUserId === mentionedUserId) return false;
	 ...
	 */
	static async getUserMentions(userId: string, page = 1, limit = 20) {
	 ...
	 */
	static async markMentionsAsRead(userId: string, mentionIds?: number[]) {
	 ...
	 */
	static async searchUsersForMention(query: string, limit = 10) {
	 ...
	 */
	static async updateUserMentionPreferences(userId: string, preferences: Partial<any>) {
