...
import { users, levels, titles, badges, userBadges, userTitles, xpAdjustmentLogs } from '@shared/schema';
...
export class XpService {
   ...
   */
  async getActionLimitsForUser(userId: number, action: XP_ACTION): Promise<{
