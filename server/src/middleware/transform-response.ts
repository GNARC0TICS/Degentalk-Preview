...
export const createTransformMiddleware = <T>(
...
export const transformTransactionResponse = createTransformMiddleware(transform.transformTransaction);
export const transformMessageResponse = createTransformMiddleware(transform.transformMessage);
export const transformConversationResponse = createTransformMiddleware(transform.transformConversation);
...
function hasConversationFields(obj: any): boolean {
  return obj && ('userId' in obj || 'user_id' in obj) && ('lastMessage' in obj || 'last_message' in obj);
}
...
function transformUnknownObject(obj: any): any {
  ...
  const idFields = [
    'id', 'userId', 'threadId', 'postId', 'forumId', 'walletId', 
    'transactionId', 'itemId', 'frameId', 'badgeId', 'titleId',
