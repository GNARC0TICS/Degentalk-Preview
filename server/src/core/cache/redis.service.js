...
class RedisCacheService {
    ...
    metrics = { hits: 0, misses: 0, errors: 0, hitRate: 0 };
    constructor() {
...
export const CacheMinute = (minutes = 1) => Cache({ ttl: minutes * 60 * 1000 });
export const CacheHour = (hours = 1) => Cache({ ttl: hours * 60 * 60 * 1000 });
export const CacheDay = (days = 1) => Cache({ ttl: days * 24 * 60 * 60 * 1000 });
