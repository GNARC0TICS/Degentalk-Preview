...
export type RepositoryErrorCode = 'NOT_FOUND' | 'VALIDATION_ERROR' | 'DUPLICATE_ERROR' | 'FOREIGN_KEY_ERROR' | 'CONSTRAINT_ERROR' | 'CONNECTION_ERROR' | 'TIMEOUT_ERROR' | 'UNKNOWN_ERROR';
