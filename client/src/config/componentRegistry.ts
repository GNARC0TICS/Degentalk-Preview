...
export const componentRegistry = {
  ...
  forumNav: () => import('@/features/forum/components/HierarchicalZoneNav').then(module => ({ default: module.default })),
  leaderboard: () => import('@/components/sidebar/leaderboard-widget').then(module => ({ default: module.default })),
  activeMembers: () => import('@/components/users/ActiveMembersWidget').then(module => ({ default: module.default })),
