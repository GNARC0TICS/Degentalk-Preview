...
const ForumRules: React.FC = () => {
  ...
  const allRequiredRulesAgreed = React.useMemo(() => {
    ...
    const requiredRules = rules.data.filter((rule: ForumRule) => 
      rule.status === 'published' && rule.isRequired
    );
    ...
    <div className="container mx-auto py-8">
      ...
      <div className="mb-8">
        ...
        {isAuthenticated && !allRequiredRulesAgreed && (
          <Alert className="mt-4" variant="default"> {/* Changed "warning" to "default" */}
        ...
        {isAuthenticated && allRequiredRulesAgreed && (
          <Alert className="mt-4" variant="default">
            ...
            <AlertDescription>
              You have agreed to all required forum rules. Thank you for being a part of our community!
            </AlertDescription>
          </Alert>
        )}
      </div>
          ...
          <TabsContent key={section} value={section} className="space-y-4">
            {groupedRules[section]?.map(rule => (
              <Card key={rule.id} className="mb-4">
                  ...
                  <CardDescription>
                    {isRuleAgreedToCurrentVersion(rule) ? (
                      <span className="text-green-600 flex items-center">
                        ...
                        You agreed to this rule on {new Date(
                ...
                <CardContent>
                  <div dangerouslySetInnerHTML={{ __html: rule.content }} className="prose dark:prose-invert max-w-none" />
                </CardContent>
