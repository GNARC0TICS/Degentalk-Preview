  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-zinc-950 to-black">
      <div className="container mx-auto px-4 py-8">
        ...
        >
          <Link href="/">
            <Button variant="ghost" className="flex items-center text-zinc-400 hover:text-white transition-colors">
              ...
              <div className="flex items-center gap-3 mt-3">
                ...
                {selectedCategory !== 'all' && (
                  <Badge variant="outline" className="bg-emerald-900/20 text-emerald-400 border-emerald-500/30">
                    {selectedCategoryData?.icon && <selectedCategoryData.icon className="w-3 h-3 mr-1" />}
