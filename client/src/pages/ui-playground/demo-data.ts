...
export const usernameTiers = [
  ...
  { tier: 'exit-liquidity', color: 'text-red-400 animate-pulse', label: 'Exit Liquidity', xpRange: '100,000+' }
];
...
export const avatarFrameRarities = [
  ...
  { rarity: 'rare', borderClass: 'ring-2 ring-blue-500', glowClass: 'shadow-[0_0_10px_rgba(59,130,246,0.5)]' },
  { rarity: 'epic', borderClass: 'ring-2 ring-purple-500', glowClass: 'shadow-[0_0_15px_rgba(168,85,247,0.5)]' },
  { rarity: 'legendary', borderClass: 'ring-2 ring-yellow-400', glowClass: 'shadow-[0_0_20px_rgba(250,204,21,0.6)]' },
  { 
    rarity: 'mythic', 
