      ...
      <Card className="bg-zinc-900/60 border-zinc-800">
        ...
        <CardContent>
          <div className="flex flex-wrap gap-3">
            <Badge className="gap-2 bg-gradient-to-r from-yellow-500 to-amber-500 text-black">Gold</Badge>
            <Badge className="gap-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white">Epic</Badge>
            <Badge className="gap-2 bg-gradient-to-r from-emerald-500 to-cyan-500 text-black">Rare</Badge>
          </div>
        </CardContent>
      </Card>
    </div>
