  ...
  <PlaygroundSection id="buttons" title="Buttons">
    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div className="space-y-4">
        ...
        <Button variant="gradient" leftIcon={<Rocket className="h-4 w-4" />}>To the Moon</Button>
      ...
      <div className="space-y-4">
        ...
        <Button variant="destructive" leftIcon={<Lock className="h-4 w-4" />}>Lock Account</Button>
      ...
      <div className="space-y-4">
        ...
        <Button variant="ghost" leftIcon={<MessageSquare className="h-4 w-4" />}>Reply</Button>
      ...
      <div className="space-y-4">
        ...
        <Button variant="glow" animation="glow">Animated</Button>
        <Button variant="glow" leftIcon={<Zap className="h-4 w-4" />}>Power Up</Button>
      </div>

      {/* Special */}
      <div className="space-y-4">
        <h3 className="font-semibold">Special</h3>
        <Button variant="wallet" leftIcon={<Wallet className="h-4 w-4" />}>Connect Wallet</Button>
        <Button variant="xp" leftIcon={<Trophy className="h-4 w-4" />}>Claim XP</Button>
        <Button variant="outline" rightIcon={<DollarSign className="h-4 w-4" />}>Buy DGT</Button>
      </div>
    </div>
  </PlaygroundSection>
);
