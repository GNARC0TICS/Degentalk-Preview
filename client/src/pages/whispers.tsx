        ...
        <div className="w-full lg:w-1/4 space-y-6">
            ...
            <CardContent>
              <div className="space-y-4">
                <StatItem 
                  label="Unread Messages" 
                  value={unreadCountData?.total || 0}
                  icon={<Badge variant="outline" className="bg-purple-900/50 text-white border-purple-500/40">New</Badge>}
                />
                {/* More stats can be added here as the system expands */}
              </div>
            </CardContent>
          ...
          <Card className="bg-black/90 backdrop-blur-xl border border-purple-500/20">
            ...
            <CardContent>
              <div className="space-y-3 text-gray-300 text-sm">
                <p>
                  <span className="text-indigo-400 font-semibold">Whispers</span> are private messages between you and another user.
                </p>
                <p>
                  Click <span className="text-indigo-400 font-semibold">New Whisper</span> to start a new conversation.
                </p>
                <p>
                  Use the <span className="text-indigo-400 font-semibold">search</span> to find specific conversations.
                </p>
                <p>
                  Messages are <span className="text-indigo-400 font-semibold">private</span> and only visible to you and the recipient.
                </p>
              </div>
            </CardContent>
          </Card>
