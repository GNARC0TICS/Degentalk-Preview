...
const adminLinks = [
  ...
  { href: "/admin/announcements", label: "Announcements", icon: <Megaphone className="h-4 w-4 mr-2" /> },
  { href: "/admin/tip-rain-settings", label: "Tip & Rain", icon: <CloudRain className="h-4 w-4 mr-2" /> },
