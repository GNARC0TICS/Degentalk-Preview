                            ...
                            {field.value && (
                              <div className="mt-2">
                                <img 
                                  ...
                                  onError={(e) => {
                                    (e.target as HTMLImageElement).src = "https://via.placeholder.com/800x200?text=Invalid+URL";
                                  }}
                                />
                              </div>
                            )}
                ...
                <Card>
                  ...
                  <CardFooter className="flex justify-between border-t p-4">
                    <div className="text-sm text-muted-foreground">
                      User ID: {data.user.id} • Created: {new Date(data.user.createdAt).toLocaleDateString()}
                    </div>
                  </CardFooter>
                </Card>
              </TabsContent>
