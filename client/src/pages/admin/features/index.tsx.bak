...
export default function FeatureGatesPage() {
  ...
  const { 
    ...
    'adminFeatureGates', 
    async () => apiRequest('/api/features/gates')
  );
            ...
            <div className="space-y-4 py-4">
              ...
              <div className="grid grid-cols-4 items-center gap-2">
                ...
                <Input
                  id="featureId"
                  value={editingFeature?.id || ''}
                  onChange={(e) => setEditingFeature(prev => prev ? { ...prev, id: e.target.value } : null)}
                  className="col-span-3"
              ...
              <div className="grid grid-cols-4 items-center gap-2">
                ...
                <Input
                  ...
                  onChange={(e) => setEditingFeature(prev => prev ? { ...prev, minLevel: parseInt(e.target.value) } : null)}
                  className="col-span-3"
                />
              </div>
              ...
              <div className="grid grid-cols-4 items-center gap-2">
                ...
                <Input
                  ...
                  onChange={(e) => setEditingFeature(prev => prev ? { ...prev, badgeRequired: e.target.value } : null)}
                  className="col-span-3"
