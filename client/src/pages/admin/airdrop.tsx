          ...
          <form onSubmit={handleSubmit}>
            <CardContent className="space-y-6">
              ...
              <div>
                ...
                <Select onValueChange={setTargetGroupId} value={targetGroupId} disabled={isLoadingGroups}>
                  <SelectTrigger id="targetGroup" className="mt-1">
                    <SelectValue placeholder={isLoadingGroups ? "Loading groups..." : "Select target group"} />
                  </SelectTrigger>
                  <SelectContent>
            ...
            <CardFooter className="border-t border-white/10 px-6 py-4">
              <Button type="submit" disabled={airdropMutation.isPending || isLoadingGroups} className="ml-auto">
