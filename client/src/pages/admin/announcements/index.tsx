      ...
      {isLoading ? (
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Manage your platform announcements. {filteredAnnouncements.length} announcement(s) found.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Table>
                    ...
                    <TableCell>
                      <div className="flex items-center space-x-2">
                        <span className="text-primary">
                          {getIconByName(announcement.icon)}
                        </span>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Add a clickable link to the announcement
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Custom text color for the announcement
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
