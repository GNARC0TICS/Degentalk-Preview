						...
						<CardContent className="space-y-6">
							<div className="grid gap-6">
								...
								{getSetting('xp_per_post') && (
									<div className="grid gap-2">
										<div className="flex items-center justify-between">
											<Label htmlFor="xp_per_post" className="text-base">
												XP per Post
											</Label>
								...
								{getSetting('xp_per_thread') && (
									<div className="grid gap-2">
										<div className="flex items-center justify-between">
											<Label htmlFor="xp_per_thread" className="text-base">
												XP per Thread
											</Label>
								...
								{getSetting('xp_multiplier_threshold') && (
									<div className="grid gap-2">
										<div className="flex items-center justify-between">
											<Label htmlFor="xp_multiplier_threshold" className="text-base">
												XP Multiplier Threshold
											</Label>
								...
								{getSetting('featured_xp_boost') && (
									<div className="grid gap-2">
										<div className="flex items-center justify-between">
											<Label htmlFor="featured_xp_boost" className="text-base">
												Featured Thread XP Boost
											</Label>
								...
								{getSetting('referral_xp_bonus') && (
									<div className="grid gap-2">
										<div className="flex items-center justify-between">
											<Label htmlFor="referral_xp_bonus" className="text-base">
												Referral XP Bonus
											</Label>
								...
								{getSetting('referral_dgt_bonus') && (
									<div className="grid gap-2">
										<div className="flex items-center justify-between">
											<Label htmlFor="referral_dgt_bonus" className="text-base">
												Referral DGT Bonus
											</Label>
						...
						<CardContent className="space-y-6">
							<div className="grid gap-6">
								...
								{getSetting('hot_thread_view_weight') && (
									<div className="grid gap-2">
										<div className="flex items-center justify-between">
											<Label htmlFor="hot_thread_view_weight" className="text-base">
												Hot Thread View Weight
											</Label>
								...
								{getSetting('hot_thread_reply_weight') && (
									<div className="grid gap-2">
										<div className="flex items-center justify-between">
											<Label htmlFor="hot_thread_reply_weight" className="text-base">
												Hot Thread Reply Weight
											</Label>
								...
								{getSetting('hot_thread_like_weight') && (
									<div className="grid gap-2">
										<div className="flex items-center justify-between">
											<Label htmlFor="hot_thread_like_weight" className="text-base">
												Hot Thread Like Weight
											</Label>
						...
						<CardContent className="space-y-6">
							<div className="grid gap-6">
								...
								{getSetting('maintenance_mode_message') && (
									<div className="grid gap-2">
										<div className="grid gap-2">
											<Label htmlFor="maintenance_message" className="text-base">
												Maintenance Message
											</Label>
...
<<<<<<< HEAD
								...
								{getSetting('disable_new_posts') && (
									<div className="grid gap-2">
										<div className="flex items-center justify-between">
											<Label htmlFor="disable_posts" className="text-base">
												Disable New Posts
											</Label>
								...
								{getSetting('disable_new_signups') && (
									<div className="grid gap-2">
										<div className="flex items-center justify-between">
											<Label htmlFor="disable_signups" className="text-base">
												Disable New Signups
											</Label>
								...
								{getSetting('beta_dev_tools_enabled') && (
									<div className="grid gap-2">
										<div className="flex items-center justify-between">
											<Label htmlFor="beta_dev_tools" className="text-base">
							...
							<div className="grid gap-6">
								<div className="space-y-4">
									...
									{getSetting('giphy_enabled') && (
										<div className="grid gap-2">
											<div className="flex items-center justify-between">
												<Label htmlFor="giphy_enabled" className="text-base">
													Enable Giphy Integration
												</Label>
									...
									{getSetting('giphy_result_limit') && (
										<div className="grid gap-2">
											<div className="flex items-center justify-between">
												<Label htmlFor="giphy_result_limit" className="text-base">
													Results Per Request
												</Label>
									...
									{getSetting('giphy_rating') && (
										<div className="grid gap-2">
											<div className="grid gap-2">
												<Label htmlFor="giphy_rating" className="text-base">
													Content Rating
												</Label>
												<div className="flex items-center gap-4">
													<Button
														type="button"
														variant={
															getSetting('giphy_rating')!.value === 'g' ? 'default' : 'outline'
														}
													...
													<Button
														type="button"
														variant={
															getSetting('giphy_rating')!.value === 'pg' ? 'default' : 'outline'
														}
													...
													<Button
														type="button"
														variant={
															getSetting('giphy_rating')!.value === 'pg-13' ? 'default' : 'outline'
														}
													...
													<Button
														type="button"
														variant={
															getSetting('giphy_rating')!.value === 'r' ? 'default' : 'outline'
														}
									...
									<div className="mt-6">
										...
										<p className="text-xs text-muted-foreground mt-2">
											The API key is configured in your environment variables and is not editable
											from this interface.
										</p>
									</div>
								</div>
				...
				<TabsContent value="treasury" className="space-y-4">
					<Card>
						<CardHeader>
							...
							<CardDescription>Configure treasury wallet and transaction settings</CardDescription>
						</CardHeader>
						<CardContent className="space-y-6">
							<div className="flex items-center justify-center">
								<div className="p-6 text-center">
									...
									<p className="text-sm text-muted-foreground max-w-md mx-auto">
										Treasury management features are planned for a future update. This will include
										wallet controls, transaction settings, and payment system configuration.
									</p>
								</div>
							</div>
						</CardContent>
