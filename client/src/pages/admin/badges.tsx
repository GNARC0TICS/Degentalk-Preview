			...
			<div className="container mx-auto py-6">
				<div className="flex items-center justify-between mb-6">
					<div>
						...
						<p className="text-muted-foreground">Create and manage badges that users can earn</p>
					</div>
				...
				<Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
					<DialogContent className="sm:max-w-[425px]">
						<DialogHeader>
							...
							<DialogDescription>Update the badge details.</DialogDescription>
						</DialogHeader>
						<Form {...form}>
								...
								{badges && badges.length > 0 ? (
									badges.map((badge) => (
										<TableRow key={badge.id}>
											...
											<TableCell>
												<Badge className={getRarityBadgeColor(badge.rarity)}>{badge.rarity}</Badge>
											</TableCell>
