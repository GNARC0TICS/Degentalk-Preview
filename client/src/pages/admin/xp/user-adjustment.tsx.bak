        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card className="md:col-span-2">
            <CardHeader>
              ...
              <CardDescription>
                Add, subtract or set a specific XP amount
              </CardDescription>
            </CardHeader>
            <CardContent>
              {selectedUser ? (
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormDescription>
                              ...
                              {field.value === 'subtract' && 'Subtract XP from the user\'s current total'}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormDescription>
                              {adjustmentForm.watch('adjustmentType') === 'add' && 'Amount of XP to add'}
                              {adjustmentForm.watch('adjustmentType') === 'subtract' && 'Amount of XP to subtract'}
                  ...
                  {recentAdjustments.map((log) => (
                    <TableRow key={log.id}>
                      ...
                      <TableCell>
                        <Badge 
                          className={
                            log.adjustmentType === 'add' ? 'bg-emerald-600' :
                            log.adjustmentType === 'subtract' ? 'bg-red-600' :
                            'bg-blue-600'
                          }
                        >
                          {log.adjustmentType === 'add' && '+'}
                          {log.adjustmentType === 'subtract' && '-'}
                          {log.adjustmentType === 'set' && '='}
                          {' '}
                          {log.amount.toLocaleString()} XP
                        </Badge>
                      </TableCell>
