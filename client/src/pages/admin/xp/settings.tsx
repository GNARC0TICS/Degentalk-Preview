...
const defaultXpSettings: XpSettings = {
	...
	postCreateXp: 10,
	threadCreateXp: 20,
	reactionReceivedXp: 2,
	postLikedXp: 1,
	dailyLoginXp: 5,
	weeklyBonusXp: 50,
	referralXp: 100,
	commentXp: 5,
	pathXpMultiplier: 1.5,
...
export default function XpSettingsPage() {
	...
	const handleResetToDefaults = () => {
		if (
			confirm('Are you sure you want to reset all XP settings to defaults? This cannot be undone.')
		) {
							...
							<TabsContent value="features" className="space-y-4">
								<Card>
									<CardHeader>
										...
										<CardDescription>Enable or disable specific XP system features</CardDescription>
									</CardHeader>
									<CardContent className="space-y-4">
										<ToggleSetting
						...
						<Card>
							<CardFooter className="border-t px-6 py-4">
								<div className="flex justify-between items-center w-full">
									...
									<Button type="submit" disabled={updateSettingsMutation.isPending || !hasChanges}>
										{updateSettingsMutation.isPending ? 'Saving...' : 'Save Changes'}
									</Button>
								</div>
							</CardFooter>
