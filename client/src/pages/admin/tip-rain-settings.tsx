  ...
  const saveRainSettings = useMutation({
    ...
    onError: (error: any) => {
      toast({
        ...
        description: error.response?.data?.message || "An error occurred while saving rain settings",
        variant: "destructive"
      });
    }
  });
      ...
      <div className="container px-4 mx-auto py-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full max-w-md grid-cols-2 mb-8">
            ...
            <TabsTrigger value="rain" className="flex items-center gap-2 data-[state=active]:bg-cyan-900/30">
                ...
                <CardContent className="space-y-6">
                  <div className="flex items-center justify-between p-4 rounded-lg bg-black/30 border border-zinc-800">
                    <div className="space-y-0.5">
                      <Label htmlFor="enable-tipping" className="text-base">Enable Tipping</Label>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => handleTipChange('processingFeePercentage', e.target.value)}
                          className="bg-zinc-900 border-zinc-800"
                        />
            ...
            <Card className="border-zinc-800 bg-zinc-950/50">
              <form onSubmit={handleSaveRainSettings}>
                ...
                <CardContent className="space-y-6">
                  <div className="flex items-center justify-between p-4 rounded-lg bg-black/30 border border-zinc-800">
                    <div className="space-y-0.5">
                      <Label htmlFor="enable-rain" className="text-base">Enable Rain</Label>
                      <p className="text-sm text-gray-400">
