    ...
    { key: 'rank', header: 'Rank' },
    {
      ...
      render: (role: Role) => (
        <div className="flex gap-1">
          {role.isAdmin && <span className="text-xs font-semibold px-2 py-0.5 rounded bg-red-500 text-white">Admin</span>}
          {role.isModerator && <span className="text-xs font-semibold px-2 py-0.5 rounded bg-yellow-500 text-black">Mod</span>}
          {role.isStaff && <span className="text-xs font-semibold px-2 py-0.5 rounded bg-blue-500 text-white">Staff</span>}
        </div>
      ),
    },
  ];
