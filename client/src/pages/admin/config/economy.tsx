...
import { useEconomyConfig, useUpdateEconomyConfig } from '@/features/admin/services/economyConfigService';
  ...
  return (
    <div className="space-y-4">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <Textarea value={json} onChange={(e) => setJson(e.target.value)} className="font-mono min-h-[600px]" />
