		...
		<div className="space-y-6">
			<div className="flex justify-between items-center">
				<div>
					...
					<p className="text-muted-foreground">Manage DGT token packages available for purchase</p>
				</div>
								...
								<div className="space-y-2">
									...
									<div className="flex gap-2">
										<Input
											...
											onChange={(e) =>
												setEditingPackage({ ...editingPackage, image_url: e.target.value })
											}
									...
									<div className="flex">
										<Input
											...
											onChange={(e) => {
												...
												setEditingPackage({
													...editingPackage,
													discount_percentage: isNaN(value)
														? undefined
