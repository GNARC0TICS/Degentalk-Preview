...
import { ForumEntity } from '@/features/forum/hooks/useForumStructure'; // Assuming ForumEntity is the correct type
...
export default function MissionControlPage() {
      ...
      <div className="min-h-screen bg-black text-white">
        <main className="container mx-auto px-4 py-8">
          <div className="text-center py-12">
            ...
            <p className="text-zinc-400">Could not load Mission Control. Please try again later.</p>
          </div>
        </main>
        <SiteFooter />
      </div>
  ...
  // Assuming PrimaryZoneLayout takes the forum data and handles rendering
  return (
    <PrimaryZoneLayout forum={forum}>
      {/* Content specific to Mission Control can go here if needed,
          or PrimaryZoneLayout can handle dynamic components based on forum.components */}
      <div>Mission Control Specific Content Placeholder</div>
    </PrimaryZoneLayout>
  );
}
