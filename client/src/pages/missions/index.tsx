...
export default function MissionsPage() {
  ...
  const completedMissionsCount = missionsWithProgress?.filter((m: MissionWithProgress) => m.progress?.isCompleted).length || 0;
  ...
  const totalPossibleXP = missionsWithProgress?.reduce((sum: number, mission: MissionWithProgress) => {
  ...
  const totalPossibleDGT = missionsWithProgress?.reduce((sum: number, mission: MissionWithProgress) => {
  ...
  const completionPercentage = totalMissionsCount > 0 ? (completedMissionsCount / totalMissionsCount) * 100 : 0;
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <Card className="bg-zinc-900 border-zinc-800 col-span-3">
              <CardHeader className="pb-2">
                ...
                <CardDescription>
                  Your progress on active missions
                </CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  <div className="flex gap-6">
                    <div className="space-y-1">
                      ...
                      <div className="text-xl font-semibold flex items-center">
                        ...
                        {claimableMissionsCount} {claimableMissionsCount === 1 ? 'Mission' : 'Missions'}
                      </div>
                    </div>
            ...
            <Card className="bg-gradient-to-br from-amber-950/50 to-zinc-900 border-amber-800/50">
              ...
              <CardContent>
                <p className="text-sm text-zinc-300">
                  Daily missions reset every 24 hours. Make sure to claim your rewards before they reset!
                </p>
