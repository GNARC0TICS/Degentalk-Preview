...
export default function ZonePage() {
  ...
  const breadcrumbItems = React.useMemo(() => {
    if (!category) return [{ label: 'Home', href: '/' }, { label: 'Forums', href: '/forums' }];
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-zinc-400">The category you're looking for doesn't exist or has been moved.</p>
          </div>
        )}
      </main>
