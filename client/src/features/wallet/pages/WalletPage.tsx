 ...
 * Wallet Page
 *
 * Main wallet management interface that displays balance, transactions,
 * and options for deposit, withdrawal, and DGT purchases.
 */
...
import { BuyDgtButton } from '../components/buy-dgt-button';
import { Link } from 'wouter';

const WalletPage: React.FC = () => {
	const { address, balance, transactionHistory, isLoading, error, refetchBalance, refetchTx } =
		useWallet();
	...
	return (
		<div className="min-h-screen bg-black text-white flex flex-col items-center px-2 py-6 md:px-0">
			<div className="w-full max-w-md space-y-6">
				<h1 className="text-3xl font-bold text-center text-emerald-400 drop-shadow-glow">
					My Wallet
				</h1>
