...
import { AnimatedBalance } from '../../../components/economy/wallet/animated-balance';
				...
				<div className="flex-1 bg-gradient-to-br from-black to-zinc-900 rounded-lg p-4 border border-zinc-800 hover:border-zinc-700 transition-all">
					<div className="flex items-center justify-between">
						<div className="flex items-center">
							...
							<div>
								<div className="text-xs text-zinc-500 uppercase font-medium">DGT Points</div>
