						...
						<div className="relative z-10 p-6">
							<div className="flex justify-between items-start mb-4">
								<div className="flex items-center gap-2">
									<ChevronUp className={cn('h-6 w-6', getLevelTextColor())} />
							...
							<div className="flex items-center gap-4 mb-6">
								...
								>
									<span className={cn('text-2xl font-bold', getLevelTextColor())}>{level}</span>
								</div>
								<div>
									<p className="text-sm text-zinc-400">You reached</p>
									<h4 className="text-xl font-bold text-white">Level {level}</h4>
									<p className="text-sm text-zinc-300">{getLevelTitle(level)}</p>
								</div>
							</div>
										...
										{rewards.badge && (
											<div className="flex items-center gap-3 p-2 rounded-md bg-zinc-800/50">
												...
												<div>
													...
													<p className="text-sm font-medium">{rewards.badge.name}</p>
												</div>
											</div>
										)}
										...
										{rewards.dgt && (
											<div className="flex items-center gap-3 p-2 rounded-md bg-zinc-800/50">
												...
												<div>
													...
													<p className="text-sm font-medium">{rewards.dgt} DGT Tokens</p>
												</div>
											</div>
										)}
									</div>
