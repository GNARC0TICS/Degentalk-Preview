      ...
      case 'badge_earned':
        return (
          <div className="flex flex-col">
            ...
            <span className="text-sm text-gray-600">
              {event.meta.badgeName || 'New badge'}
            </span>
          </div>
        );
      ...
      case 'referral_completed':
        return (
          <div className="flex flex-col">
            ...
            <span className="text-sm text-gray-600">
              {event.meta.referredUsername ? `${event.meta.referredUsername} joined` : 'New user joined'}
            </span>
          </div>
        );
      ...
      case 'mission_completed':
        return (
          <div className="flex flex-col">
            ...
            <span className="text-sm text-gray-600">
              {event.meta.missionName || 'Mission'}
            </span>
          </div>
        );
