...
export const uiConfigApi = {
    ...
    getQuote: (id: string) =>
        apiRequest(`/api/admin/ui-config/quotes/${id}`),

    // Create new quote
    createQuote: (data: CreateQuoteData) =>
        apiPost('/api/admin/ui-config/quotes', data),

    // Update existing quote
    updateQuote: (data: UpdateQuoteData) =>
        apiPut(`/api/admin/ui-config/quotes/${data.id}`, data),

    // Delete quote
    deleteQuote: (id: string) =>
        apiDelete(`/api/admin/ui-config/quotes/${id}`),

    // Reorder quotes
    reorderQuotes: (data: ReorderQuotesData) =>
        apiPost('/api/admin/ui-config/quotes/reorder', data),
    ...
    getCollections: () =>
        apiRequest('/api/admin/ui-config/collections'),
    ...
    deleteCollection: (id: string) =>
        apiDelete(`/api/admin/ui-config/collections/${id}`),
    ...
    // Import/Export
    importQuotes: (data: {
        quotes: CreateQuoteData[];
        overwriteExisting?: boolean;
    }) =>
        apiPost('/api/admin/ui-config/quotes/import', data),

    exportQuotes: async (filters?: QuoteFilters, format: 'json' | 'csv' = 'json', includeAnalytics = false) => {
