                ...
                <div>
                  <CardTitle className="text-lg text-zinc-100 flex items-center gap-2 group-hover:text-emerald-400 transition-colors">
                    ...
                    <div className="flex gap-1">
                      {isVip && (
                        <Badge variant="secondary" className="bg-amber-950/40 text-amber-300 hover:bg-amber-950/60 border border-amber-800/60 text-xs">
                          <Crown className="h-3 w-3 mr-1" />
                          VIP
                        </Badge>
                      )}
                      {isLocked && (
                        <Badge variant="secondary" className="bg-red-950/40 text-red-300 hover:bg-red-950/60 border border-red-800/60 text-xs">
                          <Lock className="h-3 w-3 mr-1" />
                          Locked
                        </Badge>
                      )}
                      {minXp && minXp > 0 && (
                        <Badge variant="secondary" className="bg-emerald-950/40 text-emerald-300 hover:bg-emerald-950/60 border border-emerald-800/60 text-xs">
