...
const prefixStyles = {
  hot: { icon: <Flame className="h-4 w-4 mr-1" />, color: 'bg-gradient-to-r from-orange-600 to-red-600 border-none text-white' },
  pinned: { icon: <ThumbsUp className="h-4 w-4 mr-1" />, color: 'bg-gradient-to-r from-cyan-600 to-blue-600 border-none text-white' },
  'scam alert': { icon: <MessageSquare className="h-4 w-4 mr-1" />, color: 'bg-gradient-to-r from-red-600 to-pink-600 border-none text-white' },
  signal: { icon: <MessageSquare className="h-4 w-4 mr-1" />, color: 'bg-gradient-to-r from-amber-600 to-yellow-600 border-none text-white' },
  strategy: { icon: <MessageSquare className="h-4 w-4 mr-1" />, color: 'bg-gradient-to-r from-emerald-600 to-green-600 border-none text-white' },
  request: { icon: <MessageSquare className="h-4 w-4 mr-1" />, color: 'bg-gradient-to-r from-blue-600 to-indigo-600 border-none text-white' },
  guide: { icon: <MessageSquare className="h-4 w-4 mr-1" />, color: 'bg-gradient-to-r from-purple-600 to-violet-600 border-none text-white' },
  shill: { icon: <MessageSquare className="h-4 w-4 mr-1" />, color: 'bg-gradient-to-r from-fuchsia-600 to-pink-600 border-none text-white' },
  leak: { icon: <MessageSquare className="h-4 w-4 mr-1" />, color: 'bg-gradient-to-r from-teal-600 to-cyan-600 border-none text-white' },
};
