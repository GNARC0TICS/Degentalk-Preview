...
export function ForumGuidelines({ className = '' }: ForumGuidelinesProps) {
	return (
		<Card
			className={`bg-zinc-900/70 border border-zinc-800 overflow-hidden hover:border-emerald-500/30 transition-colors ${className}`}
		>
			...
			<CardContent className="px-4 pb-6 pt-2">
				<p className="text-zinc-400 mb-4">
					Please be respectful and follow our community guidelines when posting. These rules help
