      ...
      <Card className={className}>
        ...
        <CardContent>
          <div className="flex flex-col items-center justify-center py-10 text-center text-zinc-500">
            ...
            <p className="text-xs">
              Earn titles by leveling up and completing achievements
            </p>
          </div>
        </CardContent>
      </Card>
            ...
            <div className="flex items-center">
              {equippedTitle ? (
                <span
                  className={cn(
                    "font-medium",
                    getTitleColorClass(equippedTitle.color)
                  )}
                >
                  {equippedTitle.name}
                </span>
          ...
          <ScrollArea className="h-[300px]">
            {titles.map((title) => (
              ...
              >
                <div className="flex items-center">
                  <span
                    className={cn("font-medium", getTitleColorClass(title.color))}
                  >
                    {title.name}
                  </span>
                  <span
              ...
              <TooltipProvider>
                <Tooltip delayDuration={300}>
                  ...
                  <TooltipContent side="top" align="end" className="max-w-[200px]">
                    <p className="text-xs">
                      Titles are displayed next to your username in posts and on
                      your profile
                    </p>
                  </TooltipContent>
                </Tooltip>
