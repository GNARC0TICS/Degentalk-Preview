    ...
    return (
      <Badge 
        className={cn(
          ...
          level < 10 ? "bg-emerald-500/20 text-emerald-400 hover:bg-emerald-500/30" : 
          level < 25 ? "bg-cyan-500/20 text-cyan-400 hover:bg-cyan-500/30" : 
          level < 50 ? "bg-purple-500/20 text-purple-400 hover:bg-purple-500/30" :
          ...
          <div className="flex items-center gap-1">
            ...
            <span 
              className={cn("text-sm font-bold", 
                level < 10 ? "text-emerald-400" : 
                level < 25 ? "text-cyan-400" : 
        ...
        <div className="flex items-center justify-between mb-3">
          ...
          {showProBadge && (
            <div className="flex items-center">
              <Badge
                className="py-1 px-2 rounded-md text-xs font-bold bg-gradient-to-r from-amber-500 to-orange-600 border-amber-700"
              >
