	...
	return (
		<Card className="bg-zinc-900 border-zinc-800">
			<CardHeader>
				...
				<CardDescription className="text-zinc-400">Purchase DGT tokens using USDT</CardDescription>
			</CardHeader>
			<CardContent>
				<div className="mb-6">
					...
					<div className="bg-emerald-950/20 border border-emerald-900/40 rounded-md p-3 mb-6">
						<div className="text-sm text-emerald-400 font-medium mb-2">DGT Calculator</div>
					...
					<div className="my-4">
						...
						<Alert
							variant="destructive"
							className="bg-red-950/30 border-red-900/40 mb-4 text-red-200"
						>
							<AlertCircle className="h-4 w-4" />
							<AlertDescription className="text-xs">
								Important: Only send USDT-TRC20 (Tron Network) to this address. Other tokens will be
								lost.
							</AlertDescription>
						</Alert>
						...
						<div className="text-sm space-y-2 text-zinc-400">
							...
							<p>
								2. Your DGT balance will be credited automatically after confirmation (usually
