      ...
      <SheetContent className="w-full max-w-md bg-zinc-900/95 border-zinc-800 text-white p-0 flex flex-col">
          ...
          {isLoadingTransactions ? (
            ...
            <div className="divide-y divide-zinc-800/50">
              {filteredTransactions.map((tx) => (
                <div key={tx.id} className="px-4 py-4 md:py-5 grid grid-cols-2 md:grid-cols-4 gap-y-2 items-center transition-colors hover:bg-zinc-800/20">
        ...
        <div className="p-4 border-t border-zinc-800 flex justify-end items-center">
          ...
          <div className="flex items-center">
            ...
            <div className="flex">
              <Button variant="ghost" size="icon" className="text-zinc-500 hover:text-white" disabled={true}> {/* TODO: Implement pagination */}
