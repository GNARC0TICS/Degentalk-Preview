				...
				<div className="bg-gradient-to-br from-amber-900/20 to-amber-800/10 rounded-lg p-4 sm:p-5 border border-amber-800/30 hover:border-amber-700/50 transition-all group">
					<div className="flex items-center justify-between mb-3">
						<div className="flex items-center space-x-3">
							...
							<div>
								<div className="text-xs text-amber-400/80 uppercase font-medium tracking-wide">
									DGT
								</div>
								<div className="text-2xl sm:text-3xl font-bold text-white">
									<AnimatedBalance value={dgtPoints} decimalPlaces={0} className="font-bold" />
								</div>
							</div>
						</div>
				...
				{pendingWithdrawals.length > 0 ? (
					<div className="flex items-start space-x-3 p-3 bg-amber-900/20 rounded-lg border border-amber-900/30">
						...
						<div className="flex-1">
							<p className="text-sm font-medium text-amber-200 mb-1">Withdrawal Processing</p>
							<p className="text-xs text-amber-300/80 leading-relaxed">
								You have {pendingWithdrawals.length} pending withdrawal
								{pendingWithdrawals.length > 1 ? 's' : ''}
								that will be processed within 24 hours. Funds will be available once processing is
								complete.
							</p>
						</div>
					</div>
					...
					<div className="flex items-start space-x-3 p-3 bg-emerald-900/20 rounded-lg border border-emerald-900/30">
						...
						<div className="flex-1">
							<p className="text-sm font-medium text-emerald-200 mb-1">Ready to Use</p>
							<p className="text-xs text-emerald-300/80 leading-relaxed">
								Your wallet balance is fully available for tips, rain events, purchases, and
								withdrawals.
							</p>
						</div>
					</div>
