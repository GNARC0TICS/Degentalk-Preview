        ...
        <CardContent>
          <Tabs defaultValue="xp" className="w-full">
            <TabsList className="w-full mb-4">
              <TabsTrigger value="xp" className="flex-1">XP Gains</TabsTrigger>
              <TabsTrigger value="posts" className="flex-1">Top Posters</TabsTrigger>
            </TabsList>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <div className="space-y-2">
            {leaderboard.slice(0, 10).map((user, index) => (
              ...
              >
                <div className="w-8 mr-2 text-center">
                  {getRankBadge(index)}
                </div>
