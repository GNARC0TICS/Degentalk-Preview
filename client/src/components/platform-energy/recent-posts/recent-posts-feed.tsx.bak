...
export function RecentPostsFeed({ 
  ...
  const { data: recentPosts, isLoading, error } = useQuery<RecentPost[]>({
          ...
          <div key={post.post_id} className="border-b border-border pb-4 last:border-0 last:pb-0">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="mt-2">
                  <div className={`prose prose-sm max-w-none dark:prose-invert ${!expanded[post.post_id] ? 'line-clamp-3' : ''}`}>
