...
const CopeButton: React.FC<CopeButtonProps> = ({ 
  ...
  return (
    <div className="cope-button-wrapper">
      <button className="button" onClick={onClick}>
        <svg stroke="#ffffff" xmlSpace="preserve" viewBox="0 0 80 80" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" id="Capa_1" version="1.1" fill="#ffffff">
