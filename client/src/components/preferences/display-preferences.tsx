	...
	return (
		<div>
			...
			<Card className="mb-6 bg-zinc-800/50 border-zinc-700">
				<CardContent className="pt-6">
					...
					<div className="bg-zinc-900 p-4 rounded-md">
						<p
							className={`text-sm ${formData.fontSize === 'small' ? 'text-sm' : formData.fontSize === 'medium' ? 'text-base' : formData.fontSize === 'large' ? 'text-lg' : 'text-xl'}`}
						>
							...
							<Label htmlFor="display-card" className="flex items-center cursor-pointer">
								...
								<div>
									...
									<p className="text-xs text-zinc-400">
										Display threads as visual cards with previews
									</p>
								</div>
							</Label>
						</div>
				...
				<CardContent className="pt-6">
					...
					<div className="space-y-4">
						...
						<div className="flex items-start justify-between">
							...
							<Switch checked={formData.hideNsfw} onCheckedChange={handleValueChange('hideNsfw')} />
						</div>

						<div className="flex items-start justify-between">
							<div>
								<Label className="text-base font-medium">Show Mature Content</Label>
								<p className="text-xs text-zinc-400">Display content marked for mature audiences</p>
							</div>
							<Switch
			...
			<div className="flex justify-end gap-3 mt-8">
				<Button type="button" variant="outline" className="border-zinc-700 bg-zinc-800/50">
					Reset to Defaults
				</Button>
				<Button
					type="button"
