...
export function ShopItemCard({ item, onPurchaseClick }: ShopItemCardProps) {
  ...
  const { isOwned, isLoading: ownershipLoading, isAuthenticated: ownershipAuth } = useShopItemOwnership(item.id);
              ...
              <TooltipTrigger asChild>
                <div className="w-full">
                  ...
                  >
                    ...
                    <span className="truncate">Requires {item.requiredXP?.toLocaleString()} XP</span>
                  </Button>
                </div>
              </TooltipTrigger>
              <TooltipContent>
