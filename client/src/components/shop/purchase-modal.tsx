			...
			<Dialog open={isOpen} onOpenChange={(open) => !open && closePurchaseModal()}>
				<DialogContent className="bg-zinc-900 border-zinc-800 text-white max-w-md">
					<div className="flex flex-col items-center justify-center py-6">
						...
						<Button onClick={closePurchaseModal}>Continue Shopping</Button>
					</div>
				</DialogContent>
			</Dialog>
		);
			...
			<DialogContent className="bg-zinc-900 border-zinc-800 text-white max-w-md">
				...
				<div className="space-y-4 my-2">
                    ...
                    `}
								...
								<p className="text-zinc-400 text-sm mb-2">{selectedItem.description}</p>
				...
				<DialogFooter>
					<Button variant="outline" onClick={closePurchaseModal} disabled={isPurchasing}>
						Cancel
					</Button>
					<Button
