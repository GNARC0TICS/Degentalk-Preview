...
type SidebarProps = {
  categories?: ForumCategory[] | ForumCategoryWithStats[]; // Ensure ForumCategoryWithStats is compatible or updated
      ...
      <Card className="bg-zinc-900/50 border border-zinc-800 shadow-md rounded-lg transition-all">
        <CardHeader className="bg-zinc-900 border-b border-zinc-800 py-3">
          <CardTitle className="text-sm font-semibold text-zinc-200 flex items-center">
            ...
            Online Members 
            <Badge variant="outline" className="ml-2 bg-emerald-900/20 text-emerald-400 border-emerald-800/30">12</Badge>
          </CardTitle>
        </CardHeader>
