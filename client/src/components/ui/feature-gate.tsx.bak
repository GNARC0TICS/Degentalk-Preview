...
export const FeatureGate: React.FC<FeatureGateProps> = ({
  ...
  const { hasAccess, isLoading, reason, unlocksAtLevel, missingBadge } = useFeatureAccess(featureId);
        ...
        >
          {reason === 'login_required' ? (
            ...
            <>
              ...
              <p className="text-zinc-400 mb-4">
                This feature unlocks at Level {unlocksAtLevel}.
                Keep participating to earn more XP!
              </p>
              <Button 
