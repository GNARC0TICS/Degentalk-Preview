...
const ChartMenu: React.FC<ChartMenuProps> = ({
  ...
  const combinedClassName = `chart-menu ${isActive ? 'is-active' : ''} ${currentPattern || ''} ${className}`.trim();
  ...
  return (
    ...
    >
      ...
      <span className="line line-1"><span className="line-inner"></span></span>
      <span className="line line-2"><span className="line-inner"></span></span>
      <span className="line line-3"><span className="line-inner"></span></span>
      
      {/* Additional elements for complex patterns */}
      <span className="line line-4"><span className="line-inner"></span></span>
      <span className="line line-5"><span className="line-inner"></span></span>
