  ...
  "flex w-full rounded-md border bg-black text-base text-white transition-all duration-200 placeholder:text-zinc-500 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm",
  {
    variants: {
      variant: {
        ...
        wallet: "border-zinc-800 focus:border-emerald-500/50 focus:ring-1 focus:ring-emerald-500/20",
        error: "border-red-900 bg-red-950/10 focus:border-red-700 focus:ring-1 focus:ring-red-700/20 placeholder:text-red-700/60",
        success: "border-emerald-900 bg-emerald-950/10 focus:border-emerald-700 focus:ring-1 focus:ring-emerald-700/20",
      },
      size: {
