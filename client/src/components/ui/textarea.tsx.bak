  ...
  "flex w-full rounded-md border bg-black text-base text-white transition-all duration-200 placeholder:text-zinc-500 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm",
  {
    variants: {
      variant: {
        ...
        comment: "border-zinc-800 focus:border-emerald-500/50 focus:ring-1 focus:ring-emerald-500/20 min-h-[60px]",
        error: "border-red-900 bg-red-950/10 focus:border-red-700 focus:ring-1 focus:ring-red-700/20 placeholder:text-red-700/60 min-h-[80px]",
      },
      size: {
        default: "px-3 py-2",
