...
export function RichTextEditor({
  ...
  const editor = useEditor({
    extensions: [
      ...
      canUseFeature('code_blocks') ? CodeBlockLowlight.configure({
        lowlight,
  ...
  const LockedFeatureButton = ({ 
    ...
    <TooltipProvider>
      <Tooltip>
        ...
        <TooltipContent>
          <p>Unlock at Level {requiredLevel} to use {feature}</p>
        </TooltipContent>
      </Tooltip>
    </TooltipProvider>
  );
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <div className="flex items-center">
                  <Button variant="ghost" size="sm" className="p-0 h-8 w-8 relative hover:bg-zinc-700">
              ...
              <TooltipTrigger asChild>
                <Button
                  ...
                  onClick={() => {
                    ...
                    container.className = 'bg-zinc-900 rounded-lg shadow-lg p-4 w-full max-w-lg max-h-[80vh] overflow-auto';
