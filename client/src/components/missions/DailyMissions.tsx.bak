...
const MissionCard: React.FC<MissionCardProps> = ({ 
  ...
  const getIconComponent = () => {
    switch (icon) {
      case 'log-in': return <Clock className="h-5 w-5" />;
      case 'message-square-plus': return <Circle className="h-5 w-5" />;
      case 'thumbs-up': return <CheckCircle className="h-5 w-5" />;
      case 'plus-circle': return <Calendar className="h-5 w-5" />;
      case 'reply': return <Calendar className="h-5 w-5" />;
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              ...
              {dgtReward && dgtReward > 0 && (
                <Badge variant="outline" className="bg-purple-950/30 border-purple-800 text-purple-300">
              ...
              {badgeReward && (
                <Badge variant="outline" className="bg-amber-950/30 border-amber-800 text-amber-300">
      ...
      <CardHeader>
        <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4">
          <div>
            ...
            <CardDescription>
              Complete missions to earn XP, DGT, and badges
            </CardDescription>
          </div>
        </div>
      </CardHeader>
