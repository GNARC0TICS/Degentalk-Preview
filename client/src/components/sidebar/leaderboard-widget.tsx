        ...
        <div className="space-y-3">
          {isLoading ? (
            ...
            Array.from({ length: 5 }).map((_, i) => (
              <div key={i} className="flex items-center justify-between p-2 rounded-md bg-zinc-800/50">
              ...
              >
                <div className="flex items-center gap-3">
                  <div className={`w-7 h-7 rounded-full flex items-center justify-center text-sm font-bold ${
                    ...
                    user.rank === 3 ? 'bg-amber-700 text-amber-200' :
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex flex-col">
                      <Link href={`/profile/${user.username}`} className="text-sm font-medium hover:text-emerald-400 transition-colors">
                        {user.username}
                      </Link>
