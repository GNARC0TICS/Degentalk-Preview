              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-col items-start space-y-1">
                    ...
                    <FormControl>
                      <Switch checked={field.value} onCheckedChange={field.onChange} aria-label="Is Staff" />
                    </FormControl>
                  </FormItem>
                )}
              />
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-col items-start space-y-1">
                    ...
                    <FormControl>
                      <Switch checked={field.value} onCheckedChange={field.onChange} aria-label="Is Moderator" />
                    </FormControl>
                  </FormItem>
                )}
              />
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-col items-start space-y-1">
                    ...
                    <FormControl>
                      <Switch checked={field.value} onCheckedChange={field.onChange} aria-label="Is Admin" />
                    </FormControl>
                  </FormItem>
                )}
              />
