          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => setFormData({ ...formData, xpRequired: parseInt(e.target.value, 10) || 0 })}
                required
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) => setFormData({ ...formData, rewardDgt: parseInt(e.target.value, 10) || 0 })}
              />
            </div>
            <div>
    ...
    <DialogContent className="sm:max-w-[400px]">
      ...
      {level && (
        <div className="py-4">
          ...
          <p className="text-sm text-muted-foreground">Required XP: {level.xpRequired.toLocaleString()}</p>
          {level.description && (
