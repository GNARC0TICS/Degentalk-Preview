...
export const getBadgeRarityDisplay = (rarityValue: string) => {
  ...
  return rarity ? { label: rarity.label, colorClass: rarity.color } : { label: rarityValue, colorClass: 'bg-slate-500' };
};
          ...
          <div className="grid gap-2">
            ...
            <div className="flex gap-2">
              <Input
                ...
                className="flex-1"
              />
              <Button type="button" variant="outline" size="icon" aria-label="Upload Icon (Placeholder)">
