            ...
            <TableBody>
              {users.map((user, index) => (
                ...
                >
                      ...
                      <div className="flex items-center space-x-3 group-hover:scale-[1.02] transition-transform">
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="flex items-center gap-2">
                            ...
                            {user.isOnline && (
                              <Badge variant="outline" className="text-xs border-emerald-500/50 text-emerald-400 bg-emerald-500/10 px-1.5 py-0">
                                Online
                              </Badge>
                            )}
                          </div>
                  ...
                  <TableCell className="text-center">
                    <div className="flex flex-col items-center">
                      <span className="text-emerald-400 font-bold text-sm">{formatNumber(user.xp)}</span>
                  ...
                  <TableCell className="text-center">
                    <div className="flex flex-col items-center">
                      <span className="text-cyan-400 font-bold text-sm">{formatNumber(user.clout)}</span>
                  ...
                  <TableCell className="text-center">
                    <div className="flex flex-col items-center">
                      <span className="text-purple-400 font-bold text-sm">{formatNumber(user.postCount)}</span>
