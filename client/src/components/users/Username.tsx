...
const SPECIAL_COLOR_CLASSES: Record<string, string> = {
  'rainbow-shimmer': 'bg-gradient-to-r from-red-500 via-yellow-500 to-purple-500 bg-clip-text text-transparent animate-gradient',
    ...
    <div className={cn("inline-flex items-center gap-1.5", className)}>
      ...
      <span 
        className={cn(
          ...
          isSpecialColor && cosmetics.usernameColor && SPECIAL_COLOR_CLASSES[cosmetics.usernameColor]
        )}
        style={displayUsernameColor && !isSpecialColor ? { color: displayUsernameColor } : undefined}
      >
        {username}
      </span>
