...
import type { OrderId, PostId, ThreadId, EntityId, type UserId } from '@shared/types';
				...
				<div className="flex items-center justify-between">
					...
					<div className="flex space-x-2">
						<DropdownMenu>
							...
							<DropdownMenuContent
								align="end"
								className="w-56 bg-black/80 backdrop-blur-md border border-white/10"
							>
								<DropdownMenuCheckboxItem
								...
								<div className="max-h-[200px] overflow-y-auto py-1">
									{xpActionsQueryData?.actions?.map((action) => (
										<DropdownMenuCheckboxItem
											...
											onCheckedChange={() =>
												setSelectedAction(selectedAction === action.action ? null : action.action)
											}
										>
