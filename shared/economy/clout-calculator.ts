 ...
 */
export function getCloutForTier(tier: number): number {
 ...
 */
export function getNextTierInfo(clout: number): {
 ...
 */
export function calculateCloutTierImpact(
	currentClout: number,
	newClout: number
): {
	currentClout: number;
 ...
 */
export function getAllCloutTiers(): CloutTier[] {
	return [...CLOUT_TIERS];
}
