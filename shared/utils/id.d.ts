 ...
 */
import type { Id, UserId, ThreadId, PostId, ForumId, StructureId, TransactionId, WalletId, ItemId, FrameId, BadgeId, TitleId, TagId, MissionId, AchievementId, ProductId, PathId, AdminId, ReportId, ConversationId, MessageId, RoomId, LevelId, EntityId } from '../types/ids.js';
/**
...
export declare const toMessageId: (id: string) => MessageId;
