 ...
 */
import type { Id, UserId, ThreadId, PostId, ForumId, StructureId, ZoneId, TransactionId, WalletId, ItemId, FrameId, BadgeId, TitleId, TagId, MissionId, AchievementId, ProductId, PathId, AdminId, ReportId, ConversationId, RoomId, LevelId, EntityId, ParentZoneId } from '../types/ids.js';
/**
...
export declare const toZoneId: (id: string) => ZoneId;
export declare const toParentZoneId: (id: string) => ParentZoneId;
