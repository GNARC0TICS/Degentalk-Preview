 ...
 */
export type ThreadListItem = Pick<Thread, 'id' | 'title' | 'slug' | 'createdAt' | 'lastPostAt' | 'isSticky' | 'isLocked' | 'viewCount' | 'postCount' | 'user' | 'featuredForum' | 'prefix' | 'excerpt' | 'relativeTime' | 'isHot' | 'hasNewReplies'>;
/**
