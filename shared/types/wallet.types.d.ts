...
export interface DgtTransactionMetadata {
    source: 'crypto_deposit' | 'shop_purchase' | 'tip_send' | 'tip_receive' | 'rain_send' | 'rain_receive' | 'admin_credit' | 'admin_debit' | 'internal_transfer_send' | 'internal_transfer_receive' | 'xp_boost' | 'manual_credit' | 'transfer_out' | 'transfer_in';
