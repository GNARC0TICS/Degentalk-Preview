...
export declare function isForum(value: unknown): value is Forum;
export declare function isThread(value: unknown): value is Thread;
export declare function isPost(value: unknown): value is Post;
export declare function isThreadSubscription(value: unknown): value is ThreadSubscription;
export declare function isThreadView(value: unknown): value is ThreadView;
export declare function isPostReaction(value: unknown): value is PostReaction;
...
export type ForumHierarchy = Forum & {
    children: ForumHierarchy[];
};
