...
// Validation helpers
export function validateUser(data: unknown): UserSchemaType {
	return UserSchema.parse(data);
}

export function validateForum(data: unknown): ForumSchemaType {
	return ForumSchema.parse(data);
}

export function validateThread(data: unknown): ThreadSchemaType {
	return ThreadSchema.parse(data);
}

export function validatePost(data: unknown): PostSchemaType {
	return PostSchema.parse(data);
}

export function validateWallet(data: unknown): WalletSchemaType {
	return WalletSchema.parse(data);
}

export function validateTransaction(data: unknown): TransactionSchemaType {
	return TransactionSchema.parse(data);
}

export function validateShopItem(data: unknown): ShopItemSchemaType {
