...
export declare function isShopItem(value: unknown): value is ShopItem;
export declare function isFrame(value: unknown): value is Frame;
export declare function isBadge(value: unknown): value is Badge;
export declare function isTitle(value: unknown): value is Title;
export declare function isItemBundle(value: unknown): value is ItemBundle;
export declare function isUserCosmetics(value: unknown): value is UserCosmetics;
...
export declare const RARITY_COLORS: RarityConfig;
