...
export const WALLET_FEATURE_GATES = [
    {
        id: 'wallet_basic',
        name: 'Basic Wallet',
...
export class WalletFeatureChecker {
     ...
     */
    static hasAccess(featureId, userLevel, isDev = false, userId) {
     ...
     */
    static getUserFeatures(userLevel, isDev = false, userId) {
     ...
     */
    static checkFeatures(featureIds, userLevel, isDev = false, userId) {
        const result = {};
