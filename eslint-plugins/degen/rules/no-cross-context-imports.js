...
const WORKSPACE_CONTEXTS = {
  'shared': {
    allowedImports: [],
    disallowedImports: ['@degentalk/client', '@degentalk/server', '@degentalk/db', '@degentalk/scripts']
  },
  'db': {
  ...
  'scripts': {
    allowedImports: ['@degentalk/shared', '@degentalk/db', '@degentalk/server', '@degentalk/client'],
    disallowedImports: []
  }
};
