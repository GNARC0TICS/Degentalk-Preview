...
module.exports = {
  meta: {
    ...
    docs: {
      description:
        'Disallow raw "container mx-auto" classes outside layout primitives',
      recommended: false,
    },
    messages: {
      badContainer:
        'Use <Wide>, <Prose>, or <FullBleedSection> instead of raw "container mx-auto".',
    },
    schema: [],
  },
    ...
    return {
      ImportDeclaration(node) {
        ...
        const hasApproved = node.specifiers.some(
          (s) =>
            s.type === 'ImportSpecifier' && APPROVED_WRAPPERS.has(s.imported.name)
        );
