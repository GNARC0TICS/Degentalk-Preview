...
ALTER TABLE "user_sessions" ADD COLUMN "sid" text PRIMARY KEY NOT NULL;--> statement-breakpoint
ALTER TABLE "user_sessions" ADD COLUMN "sess" jsonb NOT NULL;--> statement-breakpoint
...
ALTER TABLE "user_sessions" DROP COLUMN "user_agent";--> statement-breakpoint
ALTER TABLE "user_sessions" DROP COLUMN "is_active";